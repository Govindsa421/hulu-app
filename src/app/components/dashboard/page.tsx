      ...
      <div className="relative">
        ...
        <div className="flex gap-8 justify-center items-center absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white">
          <div className="text-center space-y-4">
            ...
            <button className="px-4 py-2 w-full mt-4 bg-[#4EE783] text-black">
              GET ALL THREE
            </button>
            <p>
        ...
        <div className="">
          <div
            ...
            style={{
              background:
                "linear-gradient(318.68deg, #0f495c, #0d3640 49.72%, #08141f)",
            }}
          >
            <div className="flex gap-16">
              ...
              <div className="space-y-4">
                <p className="text-[#4EE783] font-bold">
                  DISNEY BUNDLE DUO BASIC
                </p>
                <h1 className="text-2xl  text-white">
                  Both with ads, for $10.99/month.
                </h1>
              </div>
            </div>

            <div>
              <button className="px-4 py-2 bg-[#4EE783] text-black">
                GET THEM BOTH
              </button>
              <p>Terms apply</p>
            </div>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #29A869 0.66%, #16181D 99.34%)",
            }}
          >
